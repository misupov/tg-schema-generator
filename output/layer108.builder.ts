...
function _inputPhotoLegacyFileLocation(s: ByteStream, o: any) {
  i32(s, 0xd83466f3);
  o.id
  o.access_hash
  o.file_reference
...
function _wallPaperNoFile(s: ByteStream, o: any) {
  i32(s, 0x8af40b25);
...
function _updateGeoLiveViewed(s: ByteStream, o: any) {
  i32(s, 0x871fb939);
  o.peer
  i32(s, o.msg_id);
}

function _updateLoginToken(s: ByteStream, o: any) {
  i32(s, 0x564fe691);
}
...
function _webPage(s: ByteStream, o: any) {
  ...
  if (o.attributes !== undefined) o.attributes
}
...
function _poll(s: ByteStream, o: any) {
  ...
  if (o.public_voters !== undefined) o.public_voters
  if (o.multiple_choice !== undefined) o.multiple_choice
  if (o.quiz !== undefined) o.quiz
  o.question
  o.answers
}
...
function _pollAnswerVoters(s: ByteStream, o: any) {
  ...
  if (o.correct !== undefined) o.correct
  o.option
  i32(s, o.voters);
}
...
function _inputWallPaperNoFile(s: ByteStream, o: any) {
  i32(s, 0x8427bbac);
}
...
function _wallPaperSettings(s: ByteStream, o: any) {
  ...
  if (o.second_background_color !== undefined) o.second_background_color
  if (o.intensity !== undefined) o.intensity
  if (o.rotation !== undefined) o.rotation
}
...
function _autoDownloadSettings(s: ByteStream, o: any) {
  ...
  i32(s, o.video_upload_maxbitrate);
}
...
function _authLoginToken(s: ByteStream, o: any) {
  i32(s, 0x629f1980);
  i32(s, o.expires);
  o.token
}

function _authLoginTokenMigrateTo(s: ByteStream, o: any) {
  i32(s, 0x68e9916);
  i32(s, o.dc_id);
  o.token
}

function _authLoginTokenSuccess(s: ByteStream, o: any) {
  i32(s, 0x390d5c5e);
  o.authorization
}

function _accountContentSettings(s: ByteStream, o: any) {
  i32(s, 0x57e28221);
  const flags = +o.sensitive_enabled | +o.sensitive_can_change << 1;
  i32(s, flags);
  if (o.sensitive_enabled !== undefined) o.sensitive_enabled
  if (o.sensitive_can_change !== undefined) o.sensitive_can_change
}

function _messagesInactiveChats(s: ByteStream, o: any) {
  i32(s, 0xa927fec5);
  o.dates
  o.chats
  o.users
...
function _baseThemeClassic(s: ByteStream, o: any) {
  i32(s, 0xc3a12462);
}

function _baseThemeDay(s: ByteStream, o: any) {
  i32(s, 0xfbd81688);
}

function _baseThemeNight(s: ByteStream, o: any) {
  i32(s, 0xb7b31ea8);
}

function _baseThemeTinted(s: ByteStream, o: any) {
  i32(s, 0x6d5f77ee);
}

function _baseThemeArctic(s: ByteStream, o: any) {
  i32(s, 0x5b11125a);
}

function _inputThemeSettings(s: ByteStream, o: any) {
  i32(s, 0xbd507cd1);
  const flags = +!!o.message_top_color | +!!o.message_bottom_color | +!!o.wallpaper << 1 | +!!o.wallpaper_settings << 1;
  i32(s, flags);
  o.base_theme
  i32(s, o.accent_color);
  if (o.message_top_color !== undefined) o.message_top_color
  if (o.message_bottom_color !== undefined) o.message_bottom_color
  if (o.wallpaper !== undefined) o.wallpaper
  if (o.wallpaper_settings !== undefined) o.wallpaper_settings
}

function _themeSettings(s: ByteStream, o: any) {
  i32(s, 0x9c14984a);
...
function _webPageAttributeTheme(s: ByteStream, o: any) {
  i32(s, 0x54b56617);
