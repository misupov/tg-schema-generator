...
export interface MethodDeclMap {
  ...
  'messages.receivedMessages': { req: MessagesReceivedMessages, res: any },
  ...
  'messages.getAttachedStickers': { req: MessagesGetAttachedStickers, res: any },
  ...
  'upload.getCdnFileHashes': { req: UploadGetCdnFileHashes, res: any },
  ...
  'upload.getFileHashes': { req: UploadGetFileHashes, res: any },
  ...
  'account.getAllSecureValues': { req: AccountGetAllSecureValues, res: any },
  'account.getSecureValue': { req: AccountGetSecureValue, res: any },
  ...
  'contacts.getSaved': { req: ContactsGetSaved, res: any },
  ...
  'messages.getSplitRanges': { req: MessagesGetSplitRanges, res: any },
  ...
  'messages.getDialogUnreadMarks': { req: MessagesGetDialogUnreadMarks, res: any },
  ...
  'messages.getEmojiKeywordsLanguages': { req: MessagesGetEmojiKeywordsLanguages, res: any },
  ...
  'messages.getSearchCounters': { req: MessagesGetSearchCounters, res: any },
  ...
  'account.getMultiWallPapers': { req: AccountGetMultiWallPapers, res: any },
}
