class MessageParser {
  ...
  readObject() {
    switch (this.readInt()) {
      ...
      case 0xe89c45b2: return this.webPage();
      ...
      case 0x5086cf8: return this.wallPaperSettings();
      case 0xe04232f3: return this.autoDownloadSettings();
      ...
      case 0xd83466f3: return this.inputPhotoLegacyFileLocation();
      ...
      case 0x28f1114: return this.theme();
      ...
      case 0x871fb939: return this.updateGeoLiveViewed();
      case 0x564fe691: return this.updateLoginToken();
      case 0x629f1980: return this.auth_loginToken();
      case 0x68e9916: return this.auth_loginTokenMigrateTo();
      case 0x390d5c5e: return this.auth_loginTokenSuccess();
      case 0x57e28221: return this.account_contentSettings();
      case 0xa927fec5: return this.messages_inactiveChats();
      case 0xc3a12462: return this.baseThemeClassic();
      case 0xfbd81688: return this.baseThemeDay();
      case 0xb7b31ea8: return this.baseThemeNight();
      case 0x6d5f77ee: return this.baseThemeTinted();
      case 0x5b11125a: return this.baseThemeArctic();
      case 0x8427bbac: return this.inputWallPaperNoFile();
      case 0x8af40b25: return this.wallPaperNoFile();
      case 0xbd507cd1: return this.inputThemeSettings();
      case 0x9c14984a: return this.themeSettings();
      case 0x54b56617: return this.webPageAttributeTheme();
    }
  }
  ...
  webPage() {
    ...
    return {
      ...
      attributes: (flags & 0x4096) ? this.readObject() : undefined,
    }
  }
  ...
  wallPaperSettings() {
    ...
    return {
      ...
      second_background_color: (flags & 0x16) ? this.readInt() : undefined,
      intensity: (flags & 0x8) ? this.readInt() : undefined,
      rotation: (flags & 0x16) ? this.readInt() : undefined,
    }
  }
  ...
  autoDownloadSettings() {
    ...
    return {
      ...
      video_upload_maxbitrate: this.readInt(),
    }
  }
  ...
  theme() {
    ...
    return {
      ...
      settings: (flags & 0x8) ? this.readObject() : undefined,
  ...
  inputThemeSettings() {
    ...
    return {
      ...
      base_theme: this.readObject(),
      accent_color: this.readInt(),
      message_top_color: (flags & 0x1) ? this.readInt() : undefined,
      message_bottom_color: (flags & 0x1) ? this.readInt() : undefined,
      wallpaper: (flags & 0x2) ? this.readObject() : undefined,
      wallpaper_settings: (flags & 0x2) ? this.readObject() : undefined,
    }
  }
  ...
  webPageAttributeTheme() {
    ...
    return {
      ...
      documents: (flags & 0x1) ? this.readObject() : undefined,
      settings: (flags & 0x2) ? this.readObject() : undefined,
    }
  }
