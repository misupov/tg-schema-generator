...
function _webPage() {
  ...
  return {
    ...
    attributes: flags & 0x1000 ? vector(obj) : undefined,
  }
}
...
function _wallPaperSettings() {
  ...
  return {
    ...
    second_background_color: flags & 0x10 ? i32() : undefined,
    intensity: flags & 0x8 ? i32() : undefined,
    rotation: flags & 0x10 ? i32() : undefined,
  }
}
...
function _inputPhotoLegacyFileLocation() { return {_: 'inputPhotoLegacyFileLocation', id: i64(), access_hash: i64(), file_reference: bytes(), volume_id: i64(), local_id: i32(), secret: i64()}; }
...
function _theme() {
  ...
  return {
    ...
    settings: flags & 0x8 ? obj() : undefined,
    installs_count: i32(),
  }
}
...
function _updateGeoLiveViewed() { return {_: 'updateGeoLiveViewed', peer: obj(), msg_id: i32()}; }
function _updateLoginToken() { return {_: 'updateLoginToken'}; }
function _authLoginToken() { return {_: 'auth.loginToken', expires: i32(), token: bytes()}; }
function _authLoginTokenMigrateTo() { return {_: 'auth.loginTokenMigrateTo', dc_id: i32(), token: bytes()}; }
function _authLoginTokenSuccess() { return {_: 'auth.loginTokenSuccess', authorization: obj()}; }
function _accountContentSettings() {
  const flags = i32();
  return {
...
function _messagesInactiveChats() { return {_: 'messages.inactiveChats', dates: vector(i32), chats: vector(obj), users: vector(obj)}; }
function _baseThemeClassic() { return {_: 'baseThemeClassic'}; }
function _baseThemeDay() { return {_: 'baseThemeDay'}; }
function _baseThemeNight() { return {_: 'baseThemeNight'}; }
function _baseThemeTinted() { return {_: 'baseThemeTinted'}; }
function _baseThemeArctic() { return {_: 'baseThemeArctic'}; }
function _inputWallPaperNoFile() { return {_: 'inputWallPaperNoFile'}; }
function _wallPaperNoFile() {
  const flags = i32();
  return {
...
function _inputThemeSettings() {
  const flags = i32();
  return {
    _: 'inputThemeSettings' as const,
    base_theme: obj(),
    accent_color: i32(),
    message_top_color: flags & 0x1 ? i32() : undefined,
    message_bottom_color: flags & 0x1 ? i32() : undefined,
    wallpaper: flags & 0x2 ? obj() : undefined,
    wallpaper_settings: flags & 0x2 ? obj() : undefined,
  }
}
function _themeSettings() {
  const flags = i32();
  return {
...
function _webPageAttributeTheme() {
  const flags = i32();
  return {
    _: 'webPageAttributeTheme' as const,
    documents: flags & 0x1 ? vector(obj) : undefined,
    settings: flags & 0x2 ? obj() : undefined,
  }
}
